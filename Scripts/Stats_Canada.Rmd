...
Pop_CMA_1=Pop_CMA%>%
  ...
  dplyr::mutate(City = revalue(City, c("Qu\xe9bec"="Québec", "Trois-Rivi\xe8res"="Trois-Rivières", "Montr\xe9al"="Montréal" )))%>%#Correct issues with French accents in city names (é and è are \xe9 or \xe8)
...
```{r}
st_write(CMA_boundaries_red, "../Data/CMA_boundary_red.shp")
```
...
write.csv(iNat_birds_CMA, '../Data/iNat_birds_CMA.csv')
```
